			...
			<div class="page-section">
				...
				<div class="page-content">
					...
					<div class="page-loop__wrapper loop tab-content tab-content__active">
						...
						$args = array(
							'post_type' => 'buildings', // we will sort posts by date
						);
						...
						if( $query->have_posts() ) : ?>
                            ...
                            if (  $wp_query->max_num_pages > 1 ) : ?>
								<div class="show-more">
									...
									<button class="show-more__button">
										...
										<span class="show-more__button-text">Показать еще</span>
                            ...
                            echo 'Жк не найдены! попробуйте выбрать другие параметры';
				...
				<div class="page-filter fixed">
					...
					<div class="page-filter__wrapper">
						...
						<form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="page-filter" class="page-filter__form">
